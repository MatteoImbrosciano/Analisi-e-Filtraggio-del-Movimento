...
# Definizione della funzione per migliorare contrasto e luminosità
def adjust_brightness_contrast(frame, alpha=1.5, beta=50):
...
while True:
    ...
    cv2.imshow('YOLOv5 Contrast and Brightness Filter', frame)
